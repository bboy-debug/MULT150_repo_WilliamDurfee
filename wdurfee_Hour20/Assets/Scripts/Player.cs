...
public class Player : MonoBehaviour
{
    ...
    void Update() //<-- checks whether the player is currently using the spacebar. pushing the spacebar will cause the player               
    {             // to phase out and prepares to phase back in after a defined cooldown
        ...
        if (Input.GetButtonDown("Jump") && canPhase) //<--"Jump" = Spacebar
        {
            canPhase = false;
